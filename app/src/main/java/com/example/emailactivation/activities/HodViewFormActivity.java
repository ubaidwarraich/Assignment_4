...
public class HodViewFormActivity extends AppCompatActivity {
    DatabaseHelper databaseHelper;
    TextView tv_studentName,tv_semester,tv_rollno,tv_cnic,tv_message;
    EditText et_comments;
    Button btn_approve,btn_disaprove;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hod_view_form);
    ...
    private void ReturnToAdminActivity() {
        Intent intent=new Intent(HodViewFormActivity.this,HodDashboardActivity.class);
